...
<div class="divPrinc" >
    ...
    <fieldset>
    Mantenedor
        <legend class="lbl01" ><?='HOJA DE PRECALIFICACIÓN / Periodo: '.$periodoNombre.'<br />Subperiodo: '.$subPeriodoNombre?></legend>
    ...
    <!---*************************************************-->    
    <fieldset>
    	<legend class="lbl01" ><?='VALIDAR Y ACEPTAR PRECALIFICACIÓN ';?></legend>
